...
<html>
<head>
    <title>Edycja oferty kredytu hipotecznego</title>
</head>
<body>
    ...
    <form:form method="post" modelAttribute="mortgage">
        ...
        <tr><td>Min wkład własny: </td><td><form:input path="contributionPercent" /></td><td><form:errors path="contributionPercent" cssClass="error" /></td></tr>
